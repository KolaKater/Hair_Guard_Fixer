...
EXP_W = 80
EXP_H = 35
OUTER_H7 = 0.45         # V47光滑 0.80->0.45
OUTER_H15 = 0.25        # V47光滑 0.60->0.25
OUTER_H31 = 0.10        # V47光滑 0.35->0.10
OUTER_H51 = 0.03        # V47光滑 0.18->0.03
OUTER_V7 = 0.40  # V47光滑 0.85->0.40
OUTER_V15 = 0.20
OUTER_V31 = 0.08
OUTER_V7_DOWN = 0.20  # V47光滑 0.55->0.20
OUTER_V15_DOWN = 0.10
OUTER_V31_DOWN = 0.04
EXPAND_RATIO = 1.08      # V47光滑 1.3->1.08 更小扩不白
EXPAND_RATIO_V = 0.9
...
def hair_guard_fix(disp, top_ratio=0.90, thin_thresh=0.10, expand_ratio=1.5):
    ...
    d_res = disp_3x3_avg * 0.7 + disp_3x3_max * 0.3  # V47光滑 用avg为主，不再纯max白
    ...
    alpha = torch.clamp(alpha * 1.5, 0, 1)  # V47光滑 3.5->1.5, k15->21 更平滑不白
